...
class EnumArticulos {
    ...
    enum class SelectionCategory (val id: String) {
        ...
        electronica("6212ef2448b036d3701843e7"), casa("62141afa79dda0b10ec53cc3"), verhiculo("6218ea70f087df2687fb4e9f"), mueble("6218ea96f087df2687fb4ea1"), consola_videojuegos("623626fc7385ee1980852726");
